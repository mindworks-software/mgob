...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.url="https://github.com/mindworks-software/mgob" \
      org.label-schema.vcs-ref=$VCS_REF \
      org.label-schema.vcs-url="https://github.com/mindworks-software/mgob" \
      org.label-schema.vendor="mindworks.software" \
